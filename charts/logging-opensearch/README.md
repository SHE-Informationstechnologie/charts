...
| opensearch.indexTemplates.defaultTemplates.kernel | bool | `false` |  |
| opensearch.indexTemplates.defaultTemplates.kubelet | bool | `false` |  |
| opensearch.indexTemplates.defaultTemplates.syslog | bool | `false` |  |
...
| opensearch.roles[0].indexPermissions[0].indexPatterns[3] | string | `"kernel-*"` |  |
| opensearch.roles[0].indexPermissions[0].indexPatterns[4] | string | `"syslog-*"` |  |
| opensearch.roles[0].indexPermissions[0].indexPatterns[5] | string | `"kubelet-*"` |  |
