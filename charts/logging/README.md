...
| filebeat.config.filebeat.inputs[0].cursor_seek_fallback | string | `"since"` |  |
| filebeat.config.filebeat.inputs[0].id | string | `"everything"` |  |
| filebeat.config.filebeat.inputs[0].seek | string | `"cursor"` |  |
| filebeat.config.filebeat.inputs[0].since | string | `"-24h"` |  |
| filebeat.config.filebeat.inputs[0].type | string | `"journald"` |  |
...
| filebeat.daemonSet.podTemplate.spec.containers[0].volumeMounts[1].mountPath | string | `"/var/lib/docker/containers"` |  |
| filebeat.daemonSet.podTemplate.spec.containers[0].volumeMounts[1].name | string | `"varlibdockercontainers"` |  |
| filebeat.daemonSet.podTemplate.spec.containers[0].volumeMounts[2].mountPath | string | `"/var/log"` |  |
| filebeat.daemonSet.podTemplate.spec.containers[0].volumeMounts[2].name | string | `"varlog"` |  |
| filebeat.daemonSet.podTemplate.spec.containers[0].volumeMounts[2].readOnly | bool | `true` |  |
| filebeat.daemonSet.podTemplate.spec.containers[0].volumeMounts[3].mountPath | string | `"/run/log"` |  |
| filebeat.daemonSet.podTemplate.spec.containers[0].volumeMounts[3].name | string | `"runlog"` |  |
| filebeat.daemonSet.podTemplate.spec.containers[0].volumeMounts[3].readOnly | bool | `true` |  |
| filebeat.daemonSet.podTemplate.spec.containers[0].volumeMounts[4].mountPath | string | `"/run/systemd"` |  |
| filebeat.daemonSet.podTemplate.spec.containers[0].volumeMounts[4].name | string | `"runsystemd"` |  |
| filebeat.daemonSet.podTemplate.spec.containers[0].volumeMounts[4].readOnly | bool | `true` |  |
| filebeat.daemonSet.podTemplate.spec.containers[0].volumeMounts[5].mountPath | string | `"/etc/machine-id"` |  |
| filebeat.daemonSet.podTemplate.spec.containers[0].volumeMounts[5].name | string | `"etcmachineid"` |  |
| filebeat.daemonSet.podTemplate.spec.containers[0].volumeMounts[5].readOnly | bool | `true` |  |
...
| filebeat.daemonSet.podTemplate.spec.volumes[1].hostPath.path | string | `"/var/lib/docker/containers"` |  |
| filebeat.daemonSet.podTemplate.spec.volumes[1].name | string | `"varlibdockercontainers"` |  |
| filebeat.daemonSet.podTemplate.spec.volumes[2].hostPath.path | string | `"/var/log"` |  |
| filebeat.daemonSet.podTemplate.spec.volumes[2].name | string | `"varlog"` |  |
| filebeat.daemonSet.podTemplate.spec.volumes[3].hostPath.path | string | `"/run/log"` |  |
| filebeat.daemonSet.podTemplate.spec.volumes[3].name | string | `"runlog"` |  |
| filebeat.daemonSet.podTemplate.spec.volumes[4].hostPath.path | string | `"/run/systemd"` |  |
| filebeat.daemonSet.podTemplate.spec.volumes[4].name | string | `"runsystemd"` |  |
| filebeat.daemonSet.podTemplate.spec.volumes[5].hostPath.path | string | `"/etc/machine-id"` |  |
| filebeat.daemonSet.podTemplate.spec.volumes[5].name | string | `"etcmachineid"` |  |
...
| general.version | string | `"8.11.1"` |  |
| kibana.config."monitoring.ui.ccs.enabled" | bool | `false` |  |
| kibana.count | int | `1` |  |
