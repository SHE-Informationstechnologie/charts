...
| minio.serviceMonitor.namespaceSelector.any | bool | `true` |  |
| minio.serviceMonitor.selector.matchLabels."v1.min.io/tenant" | string | `"pgbackrest"` |  |
| minio.serviceMonitor.tlsConfig.insecureSkipVerify | bool | `true` |  |
| nameOverride | string | `""` |  |
